...
void setup() {
  ...
  sha.print("what do ya want for nothing?");
  printHash(sha.resultHmac());
  Serial.println();
  ...
  Serial.print("Result:");
  sha.initHmac(hmacKey3,20);
  for (a=0; a<50; a++) sha.write(0xdd);
  printHash(sha.resultHmac());
  Serial.println();
  ...
  Serial.print("Result:");
  sha.initHmac(hmacKey2,25);
  for (a=0; a<50; a++) sha.write(0xcd);
  printHash(sha.resultHmac());
  Serial.println();
  ...
  Serial.print("Result:");
  sha.initHmac(hmacKey4,20);
  sha.print("Test With Truncation");
  printHash(sha.resultHmac());
  Serial.println();
  ...
  Serial.print("Result:");
  sha.initHmac(hmacKey5,131);
  sha.print("Test Using Larger Than Block-Size Key - Hash Key First");
  printHash(sha.resultHmac());
  Serial.println();
  ...
  Serial.print("Result:");
  sha.initHmac(hmacKey5,131);
  sha.print("This is a test using a larger than block-size key and a larger than "
